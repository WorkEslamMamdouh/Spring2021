...
namespace Inv.DAL.Domain
{
    ...
    public partial class IProc_Rpt_ItemStockIncome_Result
    {
        ...
        public Nullable<decimal> TotSoldCreditQty { get; set; }
        public Nullable<decimal> TotSoldCashQty { get; set; }
        public Nullable<decimal> TotSoldCreditCost { get; set; }
        public Nullable<decimal> TotSoldCashCost { get; set; }
        public Nullable<decimal> TotSoldCreditIncome { get; set; }
