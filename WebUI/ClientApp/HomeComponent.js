...
(function (HomeComponent) {
    ...
    function InitializePages() {
        ...
        $("#btnFullStock").click(function () { OpenPage(Modules.FullStock); });
        $("#btnOperatingStock").click(function () { OpenPage(Modules.OperatingStock); });
        $("#btnRawStock").click(function () { OpenPage(Modules.RawStock); });
